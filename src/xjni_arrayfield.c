...
JNIEXPORTC j##jtype##Array Get##type##ArrayField(JNIEnv *env, jobject obj, jfieldID fid) { \
	return ubase_cast(j##jtype##Array, GetObjectArrayField(env, obj, fid)); \
} \
JNIEXPORTC j##jtype##Array GetStatic##type##ArrayField(JNIEnv *env, jclass cls, jfieldID fid) { \
	return ubase_cast(j##jtype##Array, GetStaticObjectArrayField(env, cls, fid)); \
}\
JNIEXPORTC void Set##type##ArrayField(JNIEnv *env, jobject obj, jfieldID fid, j##jtype##Array value) {\
	SetObjectArrayField(env, obj, fid, ubase_cast(jobjectArray, value));\
}\
JNIEXPORTC void SetStatic##type##ArrayField(JNIEnv *env, jclass cls, jfieldID fid, j##jtype##Array value) {\
	SetStaticObjectArrayField(env, cls, fid, ubase_cast(jobjectArray, value));\
}

// ObjectArray
JNIEXPORTC jobjectArray GetObjectArrayField(JNIEnv *env, jobject obj, jfieldID fid) {
    if (obj == NULL || fid == NULL) return NULL;
    return ubase_cast(jobjectArray,_GetObjectField(env,obj,fid));
}

JNIEXPORTC jobjectArray GetStaticObjectArrayField(JNIEnv *env, jclass cls, jfieldID fid) {
	if (cls == NULL || fid == NULL) return NULL;
	return ubase_cast(jobjectArray,_GetStaticObjectField(env,cls,fid));
}

JNIEXPORTC void SetObjectArrayField(JNIEnv *env, jobject obj, jfieldID fid, jobjectArray value) {
	if (obj == NULL || fid == NULL) return;
	_SetObjectField(env, obj, fid, ubase_cast(jobject,value));
}

JNIEXPORTC void SetStaticObjectArrayField(JNIEnv *env, jclass cls, jfieldID fid, jobjectArray value) {
	if (cls == NULL || fid == NULL) return;
	_SetStaticObjectField(env, cls, fid, ubase_cast(jobject,value));
}

// Array
JNIEXPORTC jarray GetArrayField(JNIEnv *env, jobject obj, jfieldID fid) {
	return ubase_cast(jarray,GetObjectArrayField(env,obj,fid));
}

JNIEXPORTC jarray GetStaticArrayField(JNIEnv *env, jclass cls, jfieldID fid) {
	return ubase_cast(jarray,GetStaticObjectArrayField(env,cls,fid));
}

JNIEXPORTC void SetArrayField(JNIEnv *env, jobject obj, jfieldID fid, jarray value) {
	SetObjectArrayField(env,obj,fid,ubase_cast(jobjectArray,value));
}

JNIEXPORTC void SetStaticArrayField(JNIEnv *env, jclass cls, jfieldID fid, jarray value) {
